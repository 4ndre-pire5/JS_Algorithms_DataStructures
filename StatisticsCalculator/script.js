...
// Test if an array is Even or Odd
const isEven = testArr2.length % 2 === 0;
console.log(isEven);

// Find the median of an odd array
const oddListMedian = testArr1[Math.floor(testArr1.length / 2)];
console.log(oddListMedian);

// Find the median of a even array
// first middle number -> arr[arr.length / 2]
// second middle number -> arr[(arr.length / 2) - 1]
// const evenListMedian = getMean([firsMiddleNumber, secondMiddleNumber]);
